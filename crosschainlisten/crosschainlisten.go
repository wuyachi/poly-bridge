...
import (
	...
	"github.com/polynetwork/poly-bridge/crosschainlisten/starcoinlisten"
	"github.com/polynetwork/poly-bridge/crosschainlisten/zilliqalisten"
	...
	"github.com/polynetwork/poly-bridge/crosschainlisten/neo3listen"
	"github.com/polynetwork/poly-bridge/crosschainlisten/neolisten"
	"github.com/polynetwork/poly-bridge/crosschainlisten/o3listen"
	"github.com/polynetwork/poly-bridge/crosschainlisten/ontologylisten"
	"github.com/polynetwork/poly-bridge/crosschainlisten/polylisten"
	"github.com/polynetwork/poly-bridge/crosschainlisten/switcheolisten"
...
func NewChainHandle(chainListenConfig *conf.ChainListenConfig) ChainHandle {
	...
	case basedef.ETHEREUM_CROSSCHAIN_ID, basedef.BSC_CROSSCHAIN_ID, basedef.PLT_CROSSCHAIN_ID, basedef.OK_CROSSCHAIN_ID,
		...
		basedef.KCC_CROSSCHAIN_ID, basedef.BYTOM_CROSSCHAIN_ID, basedef.HSC_CROSSCHAIN_ID, basedef.KAVA_CROSSCHAIN_ID, basedef.CUBE_CROSSCHAIN_ID:
