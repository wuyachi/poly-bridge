...
import (
	...
	"github.com/polynetwork/poly-bridge/monitor/healthmonitor/ethereummonitor"
	"github.com/polynetwork/poly-bridge/monitor/healthmonitor/neo3monitor"
	"github.com/polynetwork/poly-bridge/monitor/healthmonitor/neomonitor"
	"github.com/polynetwork/poly-bridge/monitor/healthmonitor/ontologymonitor"
	"github.com/polynetwork/poly-bridge/monitor/healthmonitor/polymonitor"
	"github.com/polynetwork/poly-bridge/monitor/healthmonitor/zilliqamonitor"
	"github.com/polynetwork/poly-bridge/utils/transactions"
...
func NewHealthMonitorHandle(monitorConfig *conf.HealthMonitorConfig) MonitorHandle {
	...
	case basedef.ETHEREUM_CROSSCHAIN_ID, basedef.O3_CROSSCHAIN_ID, basedef.BSC_CROSSCHAIN_ID, basedef.PLT_CROSSCHAIN_ID,
		...
		basedef.HARMONY_CROSSCHAIN_ID, basedef.KCC_CROSSCHAIN_ID, basedef.BYTOM_CROSSCHAIN_ID, basedef.HSC_CROSSCHAIN_ID, basedef.KAVA_CROSSCHAIN_ID, basedef.CUBE_CROSSCHAIN_ID:
