...
const (
	...
	MILKOMEDA_CROSSCHAIN_ID  = uint64(34)
...
var ETH_CHAINS = []uint64{
	...
	OASIS_CROSSCHAIN_ID, HARMONY_CROSSCHAIN_ID, KCC_CROSSCHAIN_ID, BYTOM_CROSSCHAIN_ID, HSC_CROSSCHAIN_ID, KAVA_CROSSCHAIN_ID, CUBE_CROSSCHAIN_ID, MILKOMEDA_CROSSCHAIN_ID,
}
