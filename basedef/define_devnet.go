...
var ETH_CHAINS = []uint64{
	...
	OASIS_CROSSCHAIN_ID, HARMONY_CROSSCHAIN_ID, KCC_CROSSCHAIN_ID, HSC_CROSSCHAIN_ID, ZKSYNC_CROSSCHAIN_ID,
	CELO_CROSSCHAIN_ID, CLOVER_CROSSCHAIN_ID, CONFLUX_CROSSCHAIN_ID, ASTAR_CROSSCHAIN_ID,
}
